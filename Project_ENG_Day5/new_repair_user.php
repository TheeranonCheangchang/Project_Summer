...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('✅ แจ้งซ่อมสำเร็จ'); window.location='product.php';</script>";
        exit();
    } else {
        echo "<script>alert('❌ เกิดข้อผิดพลาด: '); window.location='product.php';</script>";
        exit();
    }
}
...
<body>
    <div class="sidebar">
            ...
            <a href="product.php" class="option-card">รายการแจ้งซ่อม</a>
